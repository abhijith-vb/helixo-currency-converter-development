const enableCookiesHtml = (shop, apiKey) => {
    const HEADING = 'Third-party Cookies not supported by browser <b>(Recommended to use Google Chrome)</b>';
...
module.exports = enableCookiesHtml;
